-- ============================================================
-- Fix v2: Reemplazar todas las políticas RLS
-- ============================================================
...
DO $$ BEGIN
    ...
    drop policy if exists "Allow anon all categories" on categories;
    ...
    drop policy if exists "Allow anon all product_photos" on product_photos;
    ...
    drop policy if exists "Allow anon all sales" on sales;
    ...
    drop policy if exists "Allow anon all sale_items" on sale_items;
    ...
    drop policy if exists "Allow anon all sale_photos" on sale_photos;
    ...
    drop policy if exists "Allow anon all payment_records" on payment_records;
    ...
    drop policy if exists "Allow anon all orders" on orders;
    ...
    drop policy if exists "Allow anon all exchange_rates" on exchange_rates;
    ...
    drop policy if exists "Allow anon all contact_info" on contact_info;
    ...
    drop policy if exists "Allow anon all sales_history" on sales_history;
